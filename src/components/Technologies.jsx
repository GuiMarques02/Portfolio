...
const Technologies = () => {
    ...
    return <div className="pb-24 border-b border-neutral-600">
        ...
        <Marquee >
            ...
            <div className="p-4 transition-all ease-in-out border-4 mx-[40px] rounded-2xl border-neutral-700 hover:scale-110 group hover:bg-cyan-900 hover:bg-opacity-40">
                <RiTailwindCssFill className="text-7xl text-cyan-300 group-hover:text-cyan-300" />
            </div>
            <div className="p-4 transition-all ease-in-out border-4 mx-[40px] rounded-2xl border-neutral-700 hover:scale-110 group hover:bg-orange-900 hover:bg-opacity-30">
                <RiHtml5Fill className="text-orange-500 text-7xl group-hover:text-orange-500" />
            </div>
            <div className="p-4 transition-all ease-in-out border-4 mx-[40px] rounded-2xl border-neutral-700 hover:scale-110 group hover:bg-blue-900 hover:bg-opacity-30">
                <FaCss3Alt className="text-blue-600 text-7xl group-hover:text-blue-600" />
            </div>
            <div className="p-4 transition-all ease-in-out border-4 mx-[40px] rounded-2xl border-neutral-700 hover:scale-110 group hover:bg-cyan-900 hover:bg-opacity-30" >
                <FaJava className="text-7xl text-cyan-700 group-hover:text-cyan-700" />
            </div>
            <div className="p-4 transition-all ease-in-out border-4 mx-[40px] rounded-2xl border-neutral-700 hover:scale-110 group hover:bg-yellow-400 hover:bg-opacity-10">
                <FaPython className="text-yellow-500 text-7xl group-hover:text-yellow-500" />
            </div>
            <div className="p-4 transition-all ease-in-out border-4 mx-[40px] rounded-2xl border-neutral-700 hover:scale-110 group hover:bg-purple-700 hover:bg-opacity-20">
            ...
            <div className="p-4 transition-all ease-in-out border-4 mx-[40px] rounded-2xl border-neutral-700 hover:scale-110 group hover:bg-pink-500 hover:bg-opacity-15">
